...
class NewFood extends Renderer {
  ...
  render() {
    ...
    this.nameInput = this.renderFormGroup(
      formContainer,
      "Food Name",
      "text",
      this.food.name,
    ...
    this.quantity = this.renderFormGroup(
      formContainer,
      "Quantity",
      "number",
      this.food.quantity,
      "1",
      ["food-form-group-half"],
    )
    this.netWeight = this.renderFormGroup(
      formContainer,
      "Net Weight (g)",
      "number",
      this.food.netWeight,
    ...
    // Price input
    this.priceInput = this.renderFormGroup(
      formContainer,
      "Price ($)",
      "number",
      this.food.price,
    ...
    this.servingSize = this.renderFormGroup(
      formContainer,
      "Serving Size (g)",
      "number",
    ...
    this.calInput = this.renderFormGroup(
      formContainer,
    ...
    // Macros
    this.fatInput = this.renderFormGroup(
      formContainer,
      "Fat (g)",
      "number",
      this.food.fat,
    ...
    this.carbsInput = this.renderFormGroup(
      formContainer,
      "Carbs (g)",
      "number",
      this.food.carbs,
    ...
    this.proteinInput = this.renderFormGroup(
      formContainer,
      "Protein (g)",
      "number",
      this.food.protein,
