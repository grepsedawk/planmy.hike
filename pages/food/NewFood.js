...
class NewFood extends Renderer {
  ...
  render() {
    ...
    this.closeButton.style.cssText =
      "position: absolute; top: 10px; right: 10px; width: 30px; height: 30px; padding: 0; border-radius: 50%; background: #ff4136; font-size: 16px; display: flex; align-items: center; justify-content: center;"
