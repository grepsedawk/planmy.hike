...
class AddSection extends Renderer {
  ...
  render() {
    ...
    // Start and end mile
    this.startMile = this.renderFormGroup(
      formContainer,
      "Start Mile",
      "number",
    ...
    this.endMile = this.renderFormGroup(
      formContainer,
      "End Mile",
      "number",
    ...
    this.days = this.renderFormGroup(
      formContainer,
      "Days",
      "number",
      this.section.days,
    ...
    this.caloriesPerDay = this.renderFormGroup(
      formContainer,
      "Calories Per Day",
      "number",
