...
describe('Router', () => {
  ...
  describe('Route Matching', () => {
    ...
    test('should match parameterized route', () => {
      ...
      expect(MockFoodPage).toHaveBeenCalledWith(
        mockContentElement,
        { id: '123' }
      );
      expect(page).toBe(mockPageInstance);
    ...
    test('should return 404 page for unknown route', () => {
      ...
      expect(MockNotFoundPage).toHaveBeenCalledWith(
        mockContentElement,
        {}
      );
      expect(page).toBe(mockPageInstance);
    ...
    test('should handle multiple parameters in route', () => {
      ...
      expect(MockSectionsPage).toHaveBeenCalledWith(
        mockContentElement,
        { trailId: 'pct', sectionId: 'a' }
      );
    });
  });
  ...
  describe('Routing Process', () => {
    ...
    test('should handle rendering errors', async () => {
      ...
      const mockPageInstance = { render: jest.fn().mockRejectedValue(mockError) };
      MockSectionsPage.mockReturnValue(mockPageInstance);
  ...
  describe('Router Initialization', () => {
    test('should set up hash change listener and route initially', async () => {
      ...
      expect(mockPageInstance.render).toHaveBeenCalled();
      expect(global.console.debug).toHaveBeenCalledWith('Starting Router.init()');
      expect(global.console.debug).toHaveBeenCalledWith('Router.init() completed successfully!');
    });
